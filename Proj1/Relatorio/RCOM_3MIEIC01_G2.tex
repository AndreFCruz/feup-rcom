...
Ler o ficheiro fonte e dividi-lo em pacotes de dados (caso seja emissor);  
Reconstruir o ficheiro fonte a partir de pacotes de dados (caso seja recetor);  
Receber e enviar os pacotes; 
Terminar a ligação.
...
A função makeDataPacket que cria o pacote de dados a partir da informação original do ficheiro fonte; sendDataPacket que envia o pacote de dados utilizando llwrite; receiveDataPacket que recebe o pacote de dados utilizando llread e recolhe a informação do ficheiro fonte.

Em relação aos pacote de controlo:
A função makeControlPacket que cria o pacote de controlo; sendControlPacket que envia o pacote de controlo utilizando llwrite; receiveControlPacket que recebe o pacote utilizando llread.
